...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.si5.toylanguage.abstractsyntax.toyLanguage.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Variable_type_feature",
								"_UI_Variable_type"),
						ToyLanguagePackage.Literals.VARIABLE__TYPE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Variable_initialValue_feature",
								"_UI_Variable_type"),
						ToyLanguagePackage.Literals.VARIABLE__INITIAL_VALUE, true, false, false,
	...
	public void notifyChanged(Notification notification) {
		...
		case ToyLanguagePackage.VARIABLE__TYPE:
		case ToyLanguagePackage.VARIABLE__INITIAL_VALUE:
