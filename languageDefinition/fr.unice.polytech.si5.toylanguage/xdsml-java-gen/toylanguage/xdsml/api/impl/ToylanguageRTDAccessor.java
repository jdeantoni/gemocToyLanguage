...
public class ToylanguageRTDAccessor {
  public static java.lang.Integer getcurrentValue(EObject eObject) {
		return (java.lang.Integer)  getAspectProperty(eObject, "fr.unice.polytech.si5.toylanguage.Toylanguage", "fr.unice.polytech.si5.toylanguage.rewritingrules.VariableAspect", "currentValue");
	}
	public static boolean setcurrentValue(EObject eObject, java.lang.Integer newValue) {
		return setAspectProperty(eObject, "fr.unice.polytech.si5.toylanguage.Toylanguage", "fr.unice.polytech.si5.toylanguage.rewritingrules.VariableAspect", "currentValue", newValue);
	}
